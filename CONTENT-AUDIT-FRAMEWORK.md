...
- Hedge Funds: 12 articles
- Real Estate: 10 articles
- Infrastructure: 10 articles
- Secondaries: 10 articles
- GP Stakes: 10 articles (+ 1 in HF)
...
- [ ] Quantitative details where relevant (timeframes, typical costs, ranges)
- [ ] Citations or references to regulatory frameworks where applicable
...
- [ ] Confident subject matter expertise
...
- [ ] Paragraphs are focused and digestible (3-5 sentences max)
- [ ] Smooth transitions between sections
- [ ] Strong opening that sets context
...
- [ ] Would satisfy needs of target personas
...
- Tax articles → Tax Fee Estimator
- Compliance articles → Side Letter Obligations Tool, KYC/AML Cost Estimator
- Fundraising articles → Fund Formation Timeline Generator
- Finance/Banking articles → Subscription Credit Line Impact Visualizer
- Audit articles → Audit Fee Estimator
...
- CFTC.gov (Commodity Futures Trading Commission for certain funds)
...
4. Note missing critical topics
...
4. **Internal links** to add (specific tools/articles + placement)
5. **External links** to add (specific URLs + context)
6. **Content improvements** (rewrite needs, examples to add, etc.)
...
- Ensure consistent quality across all articles
...
- ✅ Includes 3+ external links to authoritative sources

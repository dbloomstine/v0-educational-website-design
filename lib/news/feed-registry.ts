...
export const FEED_REGISTRY: FeedSource[] = [
  ...
  {
    name: 'GNews: RE Fund Launch',
    url: googleNewsUrl('"real estate fund" launch OR close OR raise'),
    tier: 6,
    categories: ['real_estate'],
    fetchIntervalMinutes: 360,
    sourceType: 'blog',
  ...
  {
    name: 'GNews: RE Debt Fund',
    url: googleNewsUrl('"real estate debt fund" OR "real estate credit fund"'),
    tier: 6,
    categories: ['real_estate', 'credit'],
    fetchIntervalMinutes: 360,
    sourceType: 'blog',
    feedType: 'google_news',
  },
  {
    name: 'GNews: Opportunistic RE Fund',
    url: googleNewsUrl('"opportunistic real estate" fund OR "value-add real estate" fund'),
    tier: 6,
    categories: ['real_estate'],
    fetchIntervalMinutes: 360,
    sourceType: 'blog',
  ...
  {
    name: 'GNews: RE Fund Manager Hire',
    url: googleNewsUrl('"real estate" ("fund manager" OR "investment manager") hire OR appoint OR name'),
    tier: 6,
    categories: ['real_estate'],
    fetchIntervalMinutes: 360,
    sourceType: 'blog',

...
const article: Article = {
  ...
  fundType: 'gp-stakes',
  pillar: 'tax',
  content: `<p>GP-stakes funds generate three distinct income streams: steady ordinary income from management fee distributions (taxed at 37% federal), irregular capital gains from carried interest realizations (potentially 20% under Section 1061), and eventual capital gains from exiting the management company stake. Each has different character, timing, and state tax treatment requiring sophisticated tracking.</p>

<p>The complexity stems from multi-layered partnership structures—the GP-stakes fund owns equity in management companies that manage underlying funds holding portfolio companies—creating 3-4 tiers of pass-through entities. Portfolio GPs typically operate across 20-30+ states, and international operations add withholding and tax treaty requirements.</p>

<h2>GP-Stakes Tax Framework</h2>

<h3>Partnership Taxation Fundamentals</h3>

<p>Management companies organized as partnerships pass through all income, gains, losses, and deductions to partners regardless of cash distributions. This creates "phantom income" risk where partners owe taxes despite receiving no distributions—common when management companies retain cash for growth.</p>

<p>Tax basis in a management company interest equals original purchase price adjusted for: allocable income (increases basis), losses and deductions (decreases basis), additional contributions (increases), distributions received (decreases), and share of partnership liabilities under Section 752. Accurate basis tracking determines gain or loss on exit.</p>

<h3>Income Sources and Tax Character</h3>

<p><strong>Management fee distributions:</strong> Ordinary income taxed at 37% federal plus state taxes—the least tax-efficient component of GP-stakes returns.</p>

<p><strong>Carried interest distributions:</strong> Under Section 1061, carried interest receives long-term capital gain treatment (20% federal) only if underlying assets were held more than three years. Holdings sold before three years generate short-term capital gain taxed at ordinary income rates—a 17-percentage-point differential.</p>

<p><strong>Capital gains from stake sales:</strong> Exit proceeds minus adjusted basis. Most GP-stakes are held 5-10+ years, qualifying for long-term capital gains treatment.</p>

<h3>Multi-Layered Partnership Structure</h3>

<p>Income flows through four levels: portfolio companies to underlying funds to management company to GP-stakes fund to investors. The GP-stakes fund receives K-1s from management companies showing allocated income from fees and carry, then consolidates these into investor K-1s. Each layer requires basis adjustments and coordination across multiple tax advisors.</p>

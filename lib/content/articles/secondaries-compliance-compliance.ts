...
const article: Article = {
  ...
  pillar: 'compliance',
  content: `<p>Secondaries fund compliance centers on managing transfer restrictions across dozens or hundreds of underlying fund agreements, coordinating GP consent processes with varying approval requirements and timelines, satisfying regulatory transfer requirements including antitrust clearances and foreign investment reviews, and maintaining ongoing compliance obligations to multiple underlying GPs operating under their own compliance frameworks. The <a href="https://www.sec.gov" target="_blank" rel="noopener noreferrer">SEC</a> provides the primary regulatory framework governing investment advisers, while <a href="https://ilpa.org" target="_blank" rel="noopener noreferrer">ILPA</a> establishes industry best practices for LP transfers and governance.</p>

<p>The secondaries market's growth to $130+ billion in annual transaction volume (2024) has intensified regulatory scrutiny. The SEC's expanded Form ADV and Form PF reporting requirements, combined with heightened attention to conflicts in GP-led transactions (now 50-60% of secondaries volume), has elevated compliance to a strategic risk management discipline.</p>

<h2>Secondaries Compliance Framework</h2>

<h3>Multi-Layered Compliance Obligations</h3>

<p>Secondaries funds face compliance at four levels. First, the fund manager registers as an investment adviser subject to Advisers Act requirements including Form ADV filings, custody rule compliance, and marketing rule adherence, with secondaries-specific considerations around transaction descriptions, performance calculation, and conflict disclosure.</p>

<p>Second, compliance with underlying fund agreements that the secondaries fund inherits as successor LP. Each acquired LP interest subjects the fund to transfer restrictions, information rights, consent requirements, and covenants embedded in LPAs and side letters. Unlike primary funds where the manager controls terms, secondaries funds inherit terms negotiated by others across potentially hundreds of positions.</p>

<p>Third, regulatory requirements triggered by specific transactions: antitrust clearances, foreign investment reviews for non-US buyers acquiring interests in funds with sensitive portfolio companies, and financial services regulatory approvals for funds holding banking or insurance assets.</p>

<p>Fourth, ongoing obligations to underlying GPs including annual compliance questionnaires, beneficial ownership reporting, subscription document updates, and KYC/AML verification.</p>

<h3>Regulatory Framework Evolution</h3>

<p>The SEC's private fund adviser rules (2023-2024) address quarterly fee and expense reporting, fairness opinions for adviser-led transactions, and enhanced compliance documentation. While some provisions faced legal challenges, regulatory direction emphasizes transparency and conflicts management.</p>

<p>Form PF reporting has expanded to capture secondaries-specific information including transaction volumes, pricing trends, and portfolio concentrations. Form ADV requires detailed disclosure about investment strategies, conflicts, and disciplinary history, demanding regular updating as operations evolve.</p>

<p>International frameworks add complexity for funds with non-US operations. European AIFMD, UK FCA requirements, and Asian financial services regulations create cross-border obligations requiring coordination with local counsel.</p>

<h2>Transfer Restrictions and GP Consent Requirements</h2>

<h3>Common Transfer Restriction Provisions</h3>

<p>LPAs include transfer restrictions serving multiple purposes: maintaining GP control over LP composition, preventing assignments to competitors, limiting administrative burden, and complying with securities laws. The most common restriction requires GP consent for any transfer. While most established GPs cooperate with LP-led secondary sales, some impose burdensome requirements, delay approvals, or deny transfers without clear rationale.</p>

<p>Right of first refusal (ROFR) provisions give existing LPs and/or the GP the right to purchase interests on the same terms offered by third-party buyers. ROFR mechanics require the seller to provide notice of proposed sale terms, allow 30-60 days for holders to elect purchase, and permit external sale only if rights are unexercised. This adds 30-60+ days to timelines and creates deal execution risk.</p>

<p>Lock-up periods prevent transfers during specified timeframes, typically 1-3 years after initial commitment. Some LPAs include ongoing lock-ups around capital calls or distributions, requiring careful timing to avoid locked periods.</p>

<p>Minimum transfer size requirements prevent LP interest fragmentation. Many LPAs prohibit partial transfers below $5 million or 10% of total commitment, forcing sellers to transfer larger positions or preventing transfers if positions fall below minimums.</p>

<h3>GP Consent Process Management</h3>

<p>Initial diligence reviews LPA transfer restriction provisions to identify required consents, ROFR rights, lock-up periods, and other restrictions. This informs transaction structuring and flags deals facing consent challenges.</p>

<p>GP consent packages typically include transfer application forms specified in the LPA, buyer qualification information, confirmation that the buyer is not a GP competitor, and subscription documents. Thorough preparation addressing anticipated GP questions accelerates approvals.</p>

<p>Some GPs approve consents within days while others take weeks or months. The CCO maintains consent tracking systems showing pending consent status, escalation procedures, and relationships with fund administrators processing requests. Building reputation as a reliable secondaries buyer facilitates faster approvals over time.</p>

<p>When GPs deny consent, options include negotiating to address concerns, escalating to senior decision-makers, evaluating legal remedies if denial appears inconsistent with contractual obligations, or abandoning the transaction. Most disputes resolve through dialogue.</p>
...
<li><strong>Ongoing multi-fund compliance coordination demands systematic tracking:</strong> Annual compliance questionnaires, subscription document updates, beneficial ownership reporting, and various information requests from dozens of underlying fund GPs require organized systems tracking obligations, deadlines, and completion status to avoid missed requirements. Use the <a href="/tools/fund-launch-guide">Fund Launch Guide</a> to establish compliance tracking frameworks from day one.</li>
</ul>`,

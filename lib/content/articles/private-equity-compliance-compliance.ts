...
const article: Article = {
  ...
  pillar: 'compliance',
  content: `<p>Private equity fund managers operate within an intricate regulatory framework that has expanded substantially since the 2010 <a href="https://www.sec.gov/spotlight/dodd-frank.shtml" target="_blank" rel="noopener noreferrer">Dodd-Frank Act</a> eliminated the private adviser exemption and required most PE advisers to register with the <a href="https://www.sec.gov" target="_blank" rel="noopener noreferrer">Securities and Exchange Commission</a>. This shift transformed the compliance landscape for an industry that previously operated with minimal federal oversight, introducing comprehensive disclosure obligations, detailed reporting requirements, and regular examination by SEC staff.</p>

<p>The regulatory environment facing private equity fund managers encompasses multiple layers of requirements. The <a href="https://www.sec.gov/investment/investment-advisers-act-1940" target="_blank" rel="noopener noreferrer">Investment Advisers Act of 1940</a> establishes the foundational framework, requiring registered advisers to adopt compliance programs, maintain extensive books and records, provide disclosure through <a href="https://www.sec.gov/about/forms/formadv.pdf" target="_blank" rel="noopener noreferrer">Form ADV</a>, and submit to SEC examination authority. Beyond these baseline obligations, PE managers must navigate custody rules addressing the safeguarding of client assets, marketing regulations governing communications with prospective investors, political contribution restrictions designed to prevent pay-to-play arrangements, and ERISA considerations when pension plans invest in PE funds.</p>

<p>Effective compliance in private equity requires understanding these requirements, implementing robust policies and procedures tailored to PE-specific business models, and fostering a culture where regulatory obligations are integrated into investment and operational processes. This article examines the essential compliance considerations for private equity fund managers, from SEC registration through annual compliance reviews and chief compliance officer responsibilities, providing practical guidance for building and maintaining effective compliance programs.</p>

<h2>SEC Registration Under the Investment Advisers Act</h2>

<p>The Investment Advisers Act of 1940 governs the registration and regulation of investment advisers, including private equity fund managers. The Dodd-Frank Wall Street Reform and Consumer Protection Act, enacted in 2010, eliminated the private adviser exemption that most PE advisers previously relied upon, requiring advisers with $150 million or more in assets under management to register with the SEC.</p>

<p>Investment advisers managing private equity funds generally must register with the SEC once their regulatory assets under management reach the $150 million threshold. Regulatory AUM for private fund advisers is calculated based on the gross asset value of the private funds advised, without deduction for leverage, liabilities, or fund expenses. This means that a PE fund with $100 million in equity capital and $50 million in fund-level debt would contribute $150 million to the adviser's regulatory AUM calculation.</p>

<p>The registration process begins with filing Form ADV through the <a href="https://www.iard.com" target="_blank" rel="noopener noreferrer">Investment Adviser Registration Depository (IARD)</a>, an electronic filing system operated by FINRA. Initial registration requires submission of Form ADV Parts 1 and 2, payment of applicable fees, and satisfaction of state notice filing requirements in states where the adviser maintains a place of business or has more than five clients. The SEC typically processes registrations within 45 days, though the timeline can extend if questions arise or additional information is requested.</p>

<p>Registered investment advisers must update Form ADV at least annually through an annual updating amendment filed within 90 days of the adviser's fiscal year end. More frequent updates through other-than-annual amendments are required whenever information in Form ADV becomes materially inaccurate. For example, if a key employee changes roles, the adviser experiences a regulatory action, or the firm opens new offices, an other-than-annual amendment must be filed promptly to reflect the change.</p>

<h3>Exemptions from SEC Registration</h3>

<p>Certain investment advisers remain exempt from SEC registration despite managing private equity funds. The venture capital fund adviser exemption, added by Dodd-Frank, exempts advisers that advise solely venture capital funds, regardless of assets under management. To qualify, funds must meet the definition of a venture capital fund under <a href="https://www.ecfr.gov/current/title-17/chapter-II/part-275/section-275.203l-1" target="_blank" rel="noopener noreferrer">Rule 203(l)-1</a>, which requires that the fund holds no more than 20 percent of its capital in non-qualifying investments, does not incur leverage beyond limited amounts for short periods, and does not offer redemption rights to investors.</p>

<p>While many early-stage venture funds clearly qualify for this exemption, the line between venture capital and growth equity or small buyout funds can blur. Funds making control investments in established companies, using significant leverage, or holding substantial public securities or other non-qualifying investments typically cannot rely on the VC fund adviser exemption. PE managers should carefully analyze whether their funds meet the regulatory definition before claiming the exemption.</p>

<p>The private fund adviser exemption under Section 203(m) of the Advisers Act exempts advisers with less than $150 million in private fund assets under management in the United States from SEC registration. These advisers may still be required to register with state securities regulators, depending on the requirements of states where they maintain offices or clients. State registration requirements vary significantly, with some states imposing custody rules, financial requirements, and examination programs that differ from federal standards.</p>

<h2>Form ADV: Disclosure Obligations and Best Practices</h2>

<p>Form ADV serves dual purposes as both the investment adviser registration application and the primary disclosure document provided to advisory clients. The form consists of two main parts, with Part 1 collecting regulatory information about the adviser's business and Part 2 providing narrative disclosure to clients about services, fees, conflicts of interest, and other material information.</p>

<h3>Form ADV Part 1: Regulatory Reporting</h3>

<p>Part 1 of Form ADV requests detailed information across multiple items and schedules covering the adviser's business, ownership, services, employees, and regulatory history. Items 1 through 4 collect basic identifying information including legal names, business addresses, SEC file number, and predecessor firm information. Items 5 through 7 address the adviser's business operations, requesting information about client types, assets under management, types of advisory services offered, and participation in client transactions.</p>

<p>For private equity fund managers, Item 5 captures information about client categories and assets under management. Most PE advisers report substantial assets in the "pooled investment vehicles" category, with smaller amounts potentially reported for separately managed accounts or other client types. The regulatory assets under management reported in Item 5 determine whether the adviser meets minimum thresholds for SEC registration and Form PF filing obligations.</p>

<p>Item 7 addresses the adviser's participation or interest in client transactions, with subsections particularly relevant to PE managers. Item 7.A requests information about whether the adviser or related persons recommend securities to clients in which the adviser or related persons have material financial interests. Private equity managers often make investments alongside their funds through co-investment vehicles or general partner commitments, creating the need for affirmative responses and appropriate disclosure.</p>

<p>Section 7.B of Form ADV applies specifically to private fund advisers, requiring detailed reporting about each private fund advised. For each fund, advisers must provide basic identification information, fund type classification, regulatory assets under management, gross asset value, strategy information, and beneficial ownership details. Private equity funds are typically classified as "private equity funds" rather than "hedge funds" or "other private funds," though fund-of-funds structures or secondary funds may require careful classification analysis.</p>

<p>Schedule A requires disclosure of direct and indirect owners of the investment adviser, typically including individuals with 25 percent or more ownership interests and any entities in the adviser's ownership chain. Schedule B requests information about all advisory clients, though advisers may omit this schedule if they have no separately managed account clients. Schedule D collects detailed information referenced in Items 7, 10, and 11, including information about private funds advised, separately managed accounts, and disciplinary history.</p>

<h3>Form ADV Part 2: The Firm Brochure</h3>

<p>Form ADV Part 2 serves as the adviser's disclosure document, written in narrative format and delivered to clients and prospective clients. The brochure must be written in plain English, avoiding legal and compliance jargon in favor of clear, straightforward descriptions of the adviser's business practices and conflicts of interest.</p>
...
<p>Item 5 addresses fees and compensation, requiring detailed disclosure of fee structures including management fees, performance-based fees, and any other compensation received. Private equity funds typically charge management fees calculated as a percentage of committed capital during the investment period and invested capital or net asset value thereafter, with the transition point and calculation methodology varying by fund. The brochure should clearly explain these fee calculations, including how capital is measured, when fees are charged, and how the basis for fee calculation changes over the fund's lifecycle.</p>

<p>Performance fees in private equity typically take the form of carried interest, where the general partner receives a percentage (commonly 20 percent) of fund profits after returning capital and preferred returns to limited partners. Item 5 should describe the carried interest structure, including the preferred return threshold (often 8 percent), whether the waterfall is American-style (calculated at the fund level) or European-style (calculated on individual investments), and any clawback provisions that may require the general partner to return carried interest distributions in certain circumstances.</p>

<p>Items 6 through 8 address performance-based fees, types of clients advised, and methods of analysis used in managing investments. Item 8 requires description of the adviser's investment strategies and methods of analysis, providing an opportunity to explain the PE fund's approach to sourcing investments, conducting due diligence, structuring transactions, working with portfolio companies post-acquisition, and ultimately realizing investments through sales or other exit events.</p>

<p>Items 10 through 12 cover conflicts of interest, particularly those arising from other financial industry activities, participation in client transactions, and brokerage practices. Private equity managers typically face numerous conflicts that require disclosure, including allocation of investment opportunities among funds, co-investment arrangements, portfolio company transactions with adviser-affiliated entities, and use of affiliated service providers. Comprehensive disclosure of these conflicts in Form ADV Part 2 is essential, as the disclosure itself serves as the primary method of addressing many conflicts under the Advisers Act.</p>

<h2>Form PF: Private Fund Reporting Requirements</h2>

<p><a href="https://www.sec.gov/about/forms/formpf.pdf" target="_blank" rel="noopener noreferrer">Form PF</a> requires registered investment advisers to report confidential information about the private funds they manage for use by the <a href="https://home.treasury.gov/policy-issues/financial-markets-financial-institutions-and-fiscal-service/fsoc" target="_blank" rel="noopener noreferrer">Financial Stability Oversight Council</a> in monitoring systemic risk. The form was adopted pursuant to Section 404 of the Dodd-Frank Act, which required the SEC and Commodity Futures Trading Commission to collect information from private fund advisers necessary for assessment of systemic risk.</p>

<p>Form PF filing obligations vary based on the adviser's regulatory assets under management and the types of private funds advised. All private fund advisers with $150 million or more in regulatory assets under management must file Form PF, though the specific sections completed and filing frequency depend on the adviser's total private fund assets and allocation across fund types.</p>

<h3>Section 1: Reporting for All Filers</h3>

<p>Section 1 of Form PF applies to all advisers required to file the form, collecting basic information about the adviser and each private fund managed. Question 1 requests identifying information about the adviser. Question 2 asks for the adviser's total private fund assets under management broken down by fund type, with private equity advisers typically reporting assets in the "private equity fund" category.</p>

<p>Questions 3 through 15 collect fund-level information about each private fund advised. Question 6 addresses strategy classification, with private equity funds typically classified using one or more of the PE-specific strategy codes such as "buyout," "growth capital," "venture capital," or "secondary." Question 7 requests information about parallel funds and master-feeder structures, while Question 8 addresses beneficial ownership concentration.</p>

<p>Questions 9 through 15 collect financial information including gross and net asset values, investor flows during the reporting period, portfolio investments, borrowing information, and derivatives exposures. For private equity funds with limited derivatives use, many of these questions require minimal information, though funds using subscription lines or other fund-level borrowing must report that information in Question 14.</p>

<h3>Section 4: Large Private Equity Fund Advisers</h3>

<p>Section 4 of Form PF applies to large private equity fund advisers, defined as advisers with at least $2 billion in private equity fund assets under management. This section collects substantially more detailed information than Section 1, requesting aggregate data across all PE funds advised as well as information about individual large funds.</p>

<p>Question 52 collects aggregate information about all private equity funds advised by qualifying large PE advisers, including total commitments, total capital called, total portfolio company debt, and geographic and sector concentration. Question 53 addresses investment performance, requesting information about internal rates of return for all PE funds managed, broken down by vintage year and investment strategy. Question 54 requests information about portfolio company characteristics including revenue, earnings, leverage multiples, and industry classifications.</p>

<p>Questions 55 through 61 collect detailed information about each qualifying private equity fund, defined as PE funds with at least $2 billion in gross assets. This fund-level reporting includes detailed portfolio company information, concentration data, leverage statistics, fund terms, and investment activity. Question 58 addresses portfolio company debt, requesting information about outstanding debt balances, debt multiples, and interest coverage ratios for portfolio companies.</p>

<p>Form PF filing frequency for large private equity fund advisers is annual, with filings due within 120 days after the adviser's fiscal year end. This timeline aligns with typical annual audit deadlines, allowing advisers to coordinate data gathering for both the audit and Form PF filing. Smaller advisers filing only Section 1 also file annually within 120 days after fiscal year end, while hedge fund advisers face quarterly filing requirements.</p>

<h2>Custody Rule Compliance</h2>

<p><a href="https://www.ecfr.gov/current/title-17/chapter-II/part-275/section-275.206%284%29-2" target="_blank" rel="noopener noreferrer">Rule 206(4)-2</a> under the Investment Advisers Act, commonly known as the custody rule, addresses the safeguarding of client assets and imposes specific requirements on advisers that have custody or possession of client funds or securities. The rule aims to protect clients from misappropriation of their assets by requiring qualified custodians, surprise examinations, and audited financial statements in certain circumstances.</p>

<p>An investment adviser has custody under the rule if the adviser holds client funds or securities directly or if the adviser has the authority to obtain possession of them. For private equity fund managers, custody status typically arises not from physical possession of assets but from the adviser's authority to withdraw or transfer fund assets, authorize portfolio company transactions on behalf of the fund, or serve as general partner or managing member of a fund structured as a limited partnership or limited liability company.</p>

<p>The custody rule establishes different requirements depending on whether the adviser has custody of pooled investment vehicle assets or separately managed account assets. For private equity funds, which are pooled investment vehicles, the primary custody rule requirement is the annual audit provision. Advisers with custody of pooled vehicle assets must, within 120 days of the fund's fiscal year end, distribute audited financial statements prepared by an independent public accountant that is registered with and subject to inspection by the <a href="https://pcaobus.org" target="_blank" rel="noopener noreferrer">Public Company Accounting Oversight Board (PCAOB)</a>.</p>

<p>This audit requirement aligns with the provisions of most private equity fund limited partnership agreements, which typically require annual audited financial statements to be delivered to limited partners within 120 days of year end. The custody rule essentially federalizes this contractual obligation, making delivery of audited financial statements a regulatory requirement and establishing specific standards for the audit.</p>
...
<p>Valuation policies for private equity funds must describe the methodologies used to value portfolio companies, the frequency of valuations, the approval process for valuation determinations, and the use of third-party valuation specialists if applicable. Given the illiquid nature of private equity investments and the judgment required in valuation, robust policies with appropriate governance help ensure consistency and defensibility of fair value determinations.</p>
...
<p>For private equity fund managers, the CCO role requires understanding both traditional investment adviser compliance and PE-specific considerations including fund structuring, limited partnership agreements, capital calls and distributions, carried interest calculations, and investor relations practices. Many PE firms hire CCOs with backgrounds at law firms specializing in investment management, compliance roles at other private fund managers, or examination experience at the SEC.</p>
...
<p>Valuation practices represent another frequent examination focus area for PE managers. Examiners review the adviser's valuation policies, assess whether valuations are determined consistently with stated policies, evaluate the independence and expertise of persons making valuation determinations, and compare valuations to subsequent events such as sales or markdowns. Significant discrepancies between quarter-end valuations and near-term sale prices often prompt examiner scrutiny.</p>

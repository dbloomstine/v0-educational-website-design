...
<p>Item 5 addresses fees and compensation. PE funds typically charge management fees on committed capital during the investment period, then invested capital or NAV thereafter. The brochure must explain fee calculations, timing, and how the basis changes over the fund lifecycle. Carried interest (commonly 20 percent of profits after returning capital and the preferred return, often 8 percent) requires disclosure of waterfall structure (American vs. European-style) and clawback provisions.</p>

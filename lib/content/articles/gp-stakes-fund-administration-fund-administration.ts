...
<p>GP-stakes fund distribution waterfalls can be complex, particularly when the fund has preferred returns, tiered economics, or multiple investor classes with different rights. Use the <a href="/tools/distribution-waterfall">Distribution Waterfall Visualizer</a> to model these allocation mechanics. <a href="https://ilpa.org" target="_blank" rel="noopener noreferrer">ILPA</a> best practices provide guidance on fair waterfall structures and LP-friendly terms.</p>
...
<p>GP-stakes fund tax reporting follows partnership taxation principles but with some unique considerations stemming from the nature of the investments. The <a href="https://www.irs.gov" target="_blank" rel="noopener noreferrer">IRS</a> provides guidance on partnership taxation and Section 1061 carried interest holding period requirements.</p>

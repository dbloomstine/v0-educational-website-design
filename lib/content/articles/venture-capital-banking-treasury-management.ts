...
<p>VC funds process dozens or hundreds of transactions monthly, including initial investments, follow-on financings, pro-rata participations, bridge notes, and SAFE conversions. Early-stage funds often maintain a single primary operating account, with treasury teams using transaction coding systems to categorize wires by portfolio company, round, and type.</p>

<p>Subscription facility accounts operate under controlled disbursement arrangements with lender security interests. Proceeds flow into pledged accounts, ensuring capital called to repay borrowings reaches the lender.</p>

<p>Multi-currency accounts reduce conversion costs of 50-100 basis points per transaction. A fund making regular European investments might maintain €5M-€10M, replenishing through bulk conversions at better pricing.</p>

<p>Distribution accounts separate operating activities from LP distributions, simplifying audits for funds with complex waterfalls or multiple share classes.</p>
...
<p>Required banking capabilities:</p>
<ul>
<li>Same-day wire processing with late-day cutoffs</li>
<li>Relationship bankers with authority to expedite seven-figure transfers</li>
<li>After-hours support with mobile contact for weekend/evening closings</li>
<li>Efficient SWIFT processing for international wires</li>
</ul>
...
<p>Verification procedures for new recipients: written GP confirmation of banking details, secondary channel verification before first-time wires. Expedited procedures for urgent situations include phone confirmation with company CFOs.</p>

<h2>Signature Authority Framework</h2>

<p>Typical tiered structure:</p>
<ul>
<li>Individual GP authority: investments up to $1M</li>
<li>Two GPs required: $1M-$5M</li>
<li>Full investment committee: exceeding $5M</li>
</ul>
...
<p>Geographically dispersed teams use online platforms or mobile authentication for approvals. Update signature cards annually and whenever partnership changes occur to avoid bottlenecks from departed partners.</p>
...
<ul>
<li>Subscription line repayment: $15M-$25M</li>
<li>Near-term investment reserves: $5M-$10M</li>
<li>Operating expenses: $2M-$3M</li>
<li>Total: 15-25% of commitments</li>
</ul>

<p>Notice periods: 10-15 business days. Call notices specify total amount, due date, wire instructions, and each LP's proportionate share. Some funds flag upcoming calls in quarterly letters to help LP liquidity planning.</p>

<p>Default remedies include 10-15% annual default interest, suspended distribution rights, and potential forfeiture. Most defaults result from administrative errors and resolve quickly; actual defaults from family office liquidity constraints require formal resolution processes.</p>
...
<p>LPA restrictions typically limit cash investment to bank deposits, money market funds, Treasuries, and investment-grade commercial paper. Large funds use automated overnight sweeps into money market funds.</p>
...
<ul>
<li>Multi-factor authentication for all banking access</li>
<li>IP address restrictions to known networks</li>
<li>Regular access reviews</li>
<li>Immediate revocation when employees leave or change roles</li>
<li>No shared credentials; regular password updates</li>
</ul>
...
<li>Target 15-25% cash during deployment, declining to 5-10% later; use subscription lines to minimize drag</li>
<li>Update signature cards annually and upon any partnership changes</li>
<li>Implement MFA, IP restrictions, and immediate access revocation for treasury systems</li>
</ul>`,

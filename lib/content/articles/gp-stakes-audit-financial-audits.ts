...
<p>Management company valuation represents the most significant audit area given material NAV impact. Auditors test: DCF model structure and formulas, key assumption support, calculation accuracy, sensitivity analysis, and consistency with prior periods. Positions representing >5-10% of NAV receive detailed review; smaller positions undergo focused procedures or sampling. External valuation specialists provide independent perspectives when significant positions or material changes warrant additional scrutiny.</p>
...
<p>Key assumptions requiring documentation: AUM growth rates, management fee structures (commitment-based vs NAV-based, step-downs), carried interest by vintage, EBITDA margins, discount rates, and terminal value assumptions. Each requires support from historical performance, portfolio GP business plans, market benchmarks, and sensitivity analysis. Weak documentation—unsupported assumptions, unjustified changes, aggressive projections exceeding historical performance—creates audit findings requiring justification or adjustments.</p>

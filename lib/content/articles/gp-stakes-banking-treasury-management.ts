...
const article: Article = {
  ...
  fundType: 'gp-stakes',
  pillar: 'banking',
  content: `<p>GP-stakes treasury coordinates acquisition financing for $50-200M+ management company purchases, quarterly management fee distributions from 8-15 portfolio GPs generating $30-150M+ annual income, and episodic carried interest distributions varying from zero to $50M+ per quarter. Unlike traditional buyout funds with binary capital deployment and distributions, GP-stakes funds experience continuous cash flows requiring active treasury management. The <a href="https://www.sec.gov" target="_blank" rel="noopener noreferrer">SEC</a> custody rules impose specific requirements on how fund managers handle investor assets and maintain proper banking controls.</p>

<p>Treasury spans credit facility management, banking relationships, cash flow forecasting, distribution waterfall administration, investor coordination, and FX management for international stakes. CFOs manage treasury directly or supervise dedicated personnel for $2B+ funds. Use the <a href="/tools/management-company-budget">Management Company Budget Planner</a> to model treasury costs and operational expenses. Annual treasury costs of $300K-$1M for $2-5B funds represent 3-6 basis points on committed capital.</p>

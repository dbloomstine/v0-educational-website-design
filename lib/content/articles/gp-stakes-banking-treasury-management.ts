...
const article: Article = {
  id: 'gp-stakes-banking-treasury-management',
  title: 'Banking and Treasury for GP-Stakes Funds: Acquisition Financing, Distribution Management, Cash Flow Forecasting, and Liquidity Optimization',
  slug: 'treasury-management',
  subtitle: 'Comprehensive guide to GP-stakes treasury covering subscription credit facilities, management fee processing, carried interest distributions, cash forecasting, liquidity management, and banking relationships',
  fundType: 'gp-stakes',
  pillar: 'banking',
  content: `<p>GP-stakes treasury coordinates acquisition financing for $50-200M+ management company purchases, quarterly management fee distributions from 8-15 portfolio GPs generating $30-150M+ annual income, and episodic carried interest distributions varying from zero to $50M+ per quarter. Unlike traditional buyout funds with binary capital deployment and distributions, GP-stakes funds experience continuous cash flows requiring active treasury management.</p>

<p>Treasury spans credit facility management, banking relationships, cash flow forecasting, distribution waterfall administration, investor coordination, and FX management for international stakes. CFOs manage treasury directly or supervise dedicated personnel for $2B+ funds. Annual treasury costs of $300K-$1M for $2-5B funds represent 3-6 basis points on committed capital.</p>

<h2>Subscription Credit Facilities and Acquisition Financing</h2>

<p>Subscription credit facilities provide revolving credit secured by uncalled LP commitments, typically sized at 15-35% of fund commitments ($150-700M for $1-2B funds) with 80-100% advance rates creating $120-700M borrowing capacity. Primary uses: bridging acquisition funding between close and capital calls (draw at closing, call capital within 30-90 days, repay), smoothing capital call frequency (quarterly versus monthly), and providing liquidity for expenses and opportunistic acquisitions.</p>
...
<p>GP-stakes funds investing in non-U.S. management companies face foreign exchange exposure requiring hedging decisions and currency management. Exposure types include: initial acquisition exposure from purchasing stakes denominated in foreign currency (Euro, British Pound), ongoing distribution exposure from receiving management fees and carry in foreign currency, and translation exposure from holding positions valued in foreign currency affecting reported NAV. Hedging strategies include: forward contracts locking in exchange rates for known future distributions, options providing downside protection while retaining upside participation, natural hedges matching foreign currency assets with foreign currency liabilities (borrowing in currency of investment), and accepting unhedged exposure betting on favorable currency movements or accepting volatility.</p>
...
<ul>
<li><strong>Subscription credit facilities enable deployment flexibility while managing LP capital call frequency:</strong> Facilities sized at 15-35% of commitments with 80-100% advance rates provide $120-700M borrowing capacity for $1-2B funds. Typical pricing includes SOFR + 150-250 bps on drawn amounts plus 25-50 bps annual commitment fee on unused capacity. Facilities bridge acquisition funding between closing and capital calls (30-90 days typical), smooth capital call frequency creating better LP experience, and provide liquidity for operating expenses and follow-ons.</li>

<li><strong>Portfolio GP distributions drive primary cash inflows requiring systematic processing and tracking:</strong> Management fee distributions arrive quarterly from 8-15 portfolio GPs generating $30-150M+ annual current income with 85-95% forecast accuracy. Carried interest distributions arrive episodically creating variability from $0 to $50M+ per quarter with 40-60% forecast accuracy depending on portfolio fund realization timing. Distribution characterization as fee income, carry realization, or return of capital affects tax treatment and investor reporting.</li>

<li><strong>Cash flow forecasting combines management fee predictability with carried interest uncertainty:</strong> Rolling 12-18 month forecasts project quarterly receipts from portfolio GPs, investment requirements from pipeline and follow-ons, operating expenses, and investor distributions. Scenario analysis addresses carry variability through probability-weighted outcomes acknowledging timing uncertainty. Liquidity buffers maintain 3-6 months operating expenses, 1-2 quarters investor distributions, and 10-20% of undeployed capital for follow-ons totaling $20-60M for $1-2B funds.</li>

<li><strong>Distribution waterfall administration allocates cash per partnership agreement terms and timing policies:</strong> Typical structures include return of capital, 8% preferred return, GP catch-up, and 80/20 or 70/30 profit split. Distribution frequency options balance investor preference for regular cash flow (quarterly distributions) against operational efficiency and liquidity optimization (discretionary distributions when accumulated cash exceeds $10-20M thresholds). Hold-back provisions retain 10-20% of distributable cash for reserves.</li>

<li><strong>Follow-on investment capacity strengthens portfolio GP partnerships and generates additional returns:</strong> Common scenarios include expansion capital for new funds or acquisitions ($10-50M), co-investments in portfolio GP-managed funds, and bridge financing during temporary cash needs. Maintaining $30-100M liquidity reserves for portfolios with 8-12 core positions enables strategic deployments strengthening relationships while generating returns on additional capital deployed at attractive valuations reflecting existing partnership relationships.</li>

<li><strong>Banking relationships require balancing operational efficiency, regulatory requirements, and risk diversification:</strong> Account structure includes main fund account, capital call accounts, distribution accounts, and segregated accounts for FX or regulatory needs. Bank selection emphasizes fund finance expertise, credit facility capacity and pricing, operational capabilities, technology platforms, and relationship breadth. Annual banking costs including account fees and wire charges range from $15K-60K for 150-300 annual transactions.</li>

<li><strong>Facility economics require cost-benefit justification balancing flexibility against interest expense:</strong> Unused commitment fees of 25-50 bps on $500M facility cost $125K-$250K annually, while drawn interest at 7.5% on $200M utilization costs $15M annually—material expenses requiring justification from deployment acceleration, LP experience improvement, or strategic flexibility. Analysis compares facility costs versus alternatives including calling capital before acquisitions (cash drag) or no facility (reduced flexibility).</li>

<li><strong>Foreign exchange exposure from international stakes requires hedging decisions:</strong> Exposure types include initial acquisition exposure, ongoing distribution exposure, and translation exposure affecting NAV. Hedging options include forward contracts (cost ~3-4% annually for Euro), options providing downside protection, natural hedges matching currency assets with liabilities, or accepting unhedged exposure. Most funds accept unhedged distribution exposure given diversification and forecasting difficulty, while some hedge acquisition purchase price at closing.</li>

<li><strong>Cash management optimizes return on temporarily held balances while maintaining distribution liquidity:</strong> Options include bank sweep accounts (minimal return), money market funds (5-5.5% currently), Treasury bills (5-5.5% with 4-13 week maturities), and liquidity management programs. Conservative approach holds 2-4 weeks estimated distributions in bank accounts, invests 1-2 months in money market funds, and considers short-term fixed income for longer balances if liquidity timing permits.</li>

<li><strong>Treasury costs represent modest 3-6 basis points on committed capital providing essential infrastructure:</strong> Annual costs of $300K-$1M for $2-5B funds include bank fees, credit facility commitment fees and interest, foreign exchange costs, and treasury personnel. Effective treasury management balances competing objectives maintaining adequate liquidity without excessive cash drag, minimizing borrowing costs while leveraging facilities for flexibility, and maximizing investor distributions while retaining strategic reserves.</li>
</ul>`,

...
const article: Article = {
  ...
  content: `<p>Investor relations for secondaries funds presents unique challenges fundamentally different from primary fund IR. While traditional buyout or venture funds emphasize company-level value creation narratives, operating improvements, and portfolio company performance, secondaries IR must articulate transaction selection skill, pricing discipline, deal sourcing capabilities, and ability to extract value from timing and market inefficiencies. The core IR message centers on demonstrable acquisition skill—the ability to identify attractive LP interests, underwrite complex multi-fund portfolios, negotiate favorable pricing, and execute transactions that deliver superior returns regardless of underlying portfolio performance inherited from sellers.</p>

<p>This distinction fundamentally shapes communication strategy. Secondaries LPs evaluate managers on transaction execution quality, demonstrated by pricing discipline (willingness to walk away from overpriced deals), win rates on competitive processes, accuracy of underwriting relative to ultimate realizations, speed of capital deployment balanced with selectivity, and portfolio construction creating diversification across strategies, vintages, and sponsors. Effective IR demonstrates these capabilities through transparent reporting on deal flow, portfolio composition with look-through exposures, and performance attribution cleanly separating acquisition timing and pricing value-add from inherited portfolio returns.</p>

<p>Additionally, secondaries funds generate more complex reporting requirements than primary funds. LPs receive exposure to dozens or hundreds of underlying funds through secondaries portfolios, each with different valuation methodologies, distribution timing, and sector/geographic exposures. IR teams must consolidate information from multiple fund administrators, present look-through exposure to thousands of underlying portfolio companies, track unfunded commitments creating future funding obligations across disparate vehicles, and provide clear visibility into expected distribution timing as underlying positions mature—all while maintaining confidentiality around seller identities and competitive transaction details. The sophistication required to communicate complex portfolio dynamics clearly distinguishes leading secondaries IR programs.</p>
...
<p>Deal flow metrics provide quarterly and trailing twelve-month statistics: opportunities reviewed (150-300+ annually), non-disclosure agreements signed indicating serious evaluation (50-100+ annually), indicative offers submitted (30-60 annually), final round participation (15-30 annually), transactions won (8-15 annually), and win rates on competitive processes (25-40% typical). Metrics demonstrate market access, transaction pipeline robustness, and selective deployment approach despite competitive pressures. Analysis of lost deals—where managers bid but lost to competitors—provides insights into pricing discipline and willingness to maintain return thresholds.</p>

...
} from '@/lib/content/service-providers'
...
const createJourneySteps = (strategy?: string): JourneyStep[] => {
  ...
  const steps: JourneyStep[] = [
    ...
    },
    {
      ...
      phase: 1,
      phaseName: 'Strategy & Planning',
      title: 'Target fund size range?',
      subtitle: 'This helps customize your checklist',
      configKey: 'size',
      options: [
    ...
    {
      id: 'fund-size-determined',
      type: 'yes-no',
      phase: 1,
      phaseName: 'Strategy & Planning',
      title: 'Specific target decided?',
      subtitle: 'Have you determined your exact target amount (e.g., $75M)?',
      taskId: 'strategy-fund-size',
    },
    {
      id: 'jurisdiction',
      type: 'config',

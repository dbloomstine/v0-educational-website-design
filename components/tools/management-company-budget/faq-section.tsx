...
/**
 * FAQ data for Management Company Budget Tool
 */
export const MANCO_BUDGET_FAQS: FAQItem[] = [
  // Basics
  {
    id: 'what-is-manco',
...
/**
 * Category configuration for ManCo Budget FAQs
 */
export const MANCO_BUDGET_FAQ_CATEGORIES: Record<string, FAQCategoryConfig> = {
  basics: { label: 'Fund Basics' },
  fees: { label: 'Fees & Economics' },
  operations: { label: 'Operations' },
  fundraising: { label: 'Fundraising' },
  tool: { label: 'Using This Tool' }
}
...
export function FAQSection({ className, compact = false }: FAQSectionProps) {
  ...
  return (
    <FAQBase
      ...
      categoryLabels={MANCO_BUDGET_FAQ_CATEGORIES}
      showSearch
      showCategoryFilter
      accordionMode
      className={className}

        ...
        <div className="grid gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.youtube.com/@dbloomstine" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-md border border-border bg-background text-muted-foreground hover:text-foreground hover:border-foreground/20 transition-colors" aria-label="YouTube">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
